...
worldDevInd <- read_excel("./datasets/World_Development_Indicators.xlsx", trim_ws=TRUE)
...
```{r tidy_index}
worldDevIndClean <- pivot_longer(worldDevInd, 'X1970..YR1970.':'X2020..YR2020.', names_to = "Year",
...
## Summary
```{r}
summary(CurrExchRatesClean)
summary(goldPricesClean)
summary(spComposite)
summary(worldDevIndClean)
